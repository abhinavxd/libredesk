...
SELECT id, created_at, updated_at, user_id, name, inbox_id, enabled, start_step_id, steps,
       on_complete_action, on_complete_assistant_id, on_complete_team_id, completion_message
FROM guided_forms
...
-- name: insert-form
INSERT INTO guided_forms (user_id, name, inbox_id, enabled, start_step_id, steps, on_complete_action, on_complete_assistant_id, on_complete_team_id, completion_message)
...
SET name = $2, inbox_id = $3, enabled = $4, start_step_id = $5, steps = $6, on_complete_action = $7,
    on_complete_assistant_id = $8, on_complete_team_id = $9, completion_message = $10, updated_at = now()
WHERE id = $1;
